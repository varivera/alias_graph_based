...
feature -- Access
	...
	first: G
			-- First element.
--		VIC:
--			{V_LINKED_LIST}.first_cell, {V_LINKED_LIST}.first.f
--			{V_LINKED_LIST}.first_cell.{V_LINKABLE}.item, {V_LINKED_LIST}.first.f.{V_LINKABLE}.item, {V_LINKED_LIST}.first.Result
--			{V_LINKED_LIST}.first_cell.{V_LINKABLE}.item2, {V_LINKED_LIST}.first.f.{V_LINKABLE}.item2
--			{V_LINKED_LIST}.first_cell.{V_LINKABLE}.right, {V_LINKED_LIST}.first.f.{V_LINKABLE}.right
		do
...
feature -- to deete (tests)
	cell_at2 (i: INTEGER): V_LINKABLE [G]
		local
			j: INTEGER
		do
			from
