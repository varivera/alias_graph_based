...
feature -- Status report
	...
	is_empty: BOOLEAN
			...
			-- Was declared in FLAT_ARRAYED_QUEUE as synonym of off.
	...
	off: BOOLEAN
			-- Is the structure empty?
			-- Was declared in FLAT_ARRAYED_QUEUE as synonym of is_empty.
		do
			Result := count = 0
		end
...
feature -- Element change
	...
	extend (v: G)
			...
			-- Was declared in FLAT_ARRAYED_QUEUE as synonym of put and force.
		local
	...
	force (v: G)
			-- Add `v' as newest item.
			-- Was declared in FLAT_ARRAYED_QUEUE as synonym of extend and put.
		local
			l_capacity: like capacity
			l_count: like count
		do
	...
	put (v: G)
			-- Add `v' as newest item.
			-- Was declared in FLAT_ARRAYED_QUEUE as synonym of extend and force.
		local
			l_capacity: like capacity
			l_count: like count
		do
...
feature {FLAT_ARRAYED_QUEUE} -- Implementation
