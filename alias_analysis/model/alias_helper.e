note
	description: "This class implements the main the functionality to add/delete/restore the Alias graph when the analysis enters in structures such as conditionals, loops or recursions "
...
feature {NONE} -- Initialiasation
	...
	make
			-- Initialises an ALIAS_HELPER and descendants
		do
			create indexes.make
...
feature -- Updating
	...
	updating_A_D (target_name, source_name: STRING; target_object, source_object: TWO_WAY_LIST [ALIAS_OBJECT]; target_path: TWO_WAY_LIST [TWO_WAY_LIST [STRING]]; target_scope: TWO_WAY_LIST [BOOLEAN]; routine_name: STRING)
			-- updates the sets `additions' and `deletions' accordingly:
			--	additions -> [`target_name': (`source_name', `source_object', `target_path', `target_scope')]
			--  deletions -> [`target_name': (`source_name', `source_object', `target_path', `target_scope')]
			-- `routine_name' is needed to identified local variables from different features inside the same the class
		require
			is_in_structure
		local
			tup: TUPLE [name, abs_name: STRING; obj: TWO_WAY_LIST [ALIAS_OBJECT]; path: TWO_WAY_LIST [TWO_WAY_LIST [STRING]]; scope: TWO_WAY_LIST [BOOLEAN]]
...
feature -- Managing Branches
	...
	step
		...
		require
			is_in_structure
		do
			additions.force (create {HASH_TABLE [TUPLE [name, abs_name: STRING; obj: TWO_WAY_LIST [ALIAS_OBJECT]; path: TWO_WAY_LIST [TWO_WAY_LIST [STRING]]; scope: TWO_WAY_LIST [BOOLEAN]], STRING]}.make (0))
			deletions.force (create {HASH_TABLE [TUPLE [name, abs_name: STRING; obj: TWO_WAY_LIST [ALIAS_OBJECT]; path: TWO_WAY_LIST [TWO_WAY_LIST [STRING]]; scope: TWO_WAY_LIST [BOOLEAN]], STRING]}.make (0))
		end
...
feature -- Access
	...
	additions: TWO_WAY_LIST [HASH_TABLE [TUPLE [name, abs_name: STRING; obj: TWO_WAY_LIST [ALIAS_OBJECT]; path: TWO_WAY_LIST [TWO_WAY_LIST [STRING]]; scope: TWO_WAY_LIST [BOOLEAN]], STRING]]
			...
			-- `scope' of the entity path. It is either an attribute (True) or a local variable (False)

	deletions: TWO_WAY_LIST [HASH_TABLE [TUPLE [name, abs_name: STRING; obj: TWO_WAY_LIST [ALIAS_OBJECT]; path: TWO_WAY_LIST [TWO_WAY_LIST [STRING]]; scope: TWO_WAY_LIST [BOOLEAN]], STRING]]
...
feature --{NONE} -- To Delete
	...
	printing_vars (va: INTEGER)
		...
		local
			ttt: TWO_WAY_LIST [HASH_TABLE [TUPLE [name, abs_name: STRING; obj: TWO_WAY_LIST [ALIAS_OBJECT]; path: TWO_WAY_LIST [TWO_WAY_LIST [STRING]]; scope: TWO_WAY_LIST [BOOLEAN]], STRING]]
		do
			if tracing then
				if va = 4 then
				else
					...
					loop
						...
						loop
							...
							print ("] scope: ")
							across
								pair_add.item.scope as scope_add
							loop
								print (scope_add.item)
								if scope_add.after then
									print (", ")
								end
							end
							print ("] abs_name: ")
